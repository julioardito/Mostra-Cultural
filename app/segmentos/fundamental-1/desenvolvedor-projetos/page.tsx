...
export default function DesenvolvedorProjetos() {
  ...
  async function executarAcao(acao: Acao, tipoLabel: string) {
    ...
    try {
      const res = await fetch("/api/fundamental-1/desenvolvedor-projetos", {
        method: "POST",
        headers: {
      ...
      setProjeto(
        "Erro ao chamar o assistente. Verifique a conexão da plataforma e tente novamente."
      );
      setTipoAtual("Erro");
    }
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18, color: "#4b5563", maxWidth: 900 }}>
          Gere propostas pedagógicas, compare versões, transforme ideias em plano
          de aula, crie checklist da Mostra e roteiro de fala dos alunos.
        </p>
        ...
        <div style={{ display: "grid", gap: 20, marginTop: 32 }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Uso consciente da água"
              style={campo}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              placeholder="Descreva a ideia do projeto, materiais disponíveis, perfil da turma ou objetivo dos professores."
          ...
          >
            <button
              type="button"
              onClick={() =>
                executarAcao("gerar_duas_propostas", "Duas propostas")
              }
              disabled={carregando}
              style={botaoAzul}
            >
            ...
            <button
              type="button"
              onClick={() =>
                executarAcao("gerar_outra_versao", "Outra versão")
              }
              disabled={carregando || !projeto}
            ...
            <button
              type="button"
              onClick={() =>
                executarAcao("comparar_propostas", "Comparação das propostas")
              }
              disabled={carregando || !projeto}
              style={botaoSecundario}
            >
            ...
            <button
              type="button"
              onClick={() => executarAcao("plano_de_aula", "Plano de aula")}
              disabled={carregando || !projeto}
              style={botaoSecundario}
            >
            ...
            <button
              type="button"
              onClick={() =>
                executarAcao("checklist_mostra", "Checklist da Mostra")
              }
              disabled={carregando || !projeto}
              style={botaoSecundario}
            >
            ...
            <button
              type="button"
              onClick={() =>
                executarAcao("roteiro_fala", "Roteiro de fala dos alunos")
              }
              disabled={carregando || !projeto}
              style={botaoSecundario}
            >
      ...
      {projeto && (
        <section style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            <button type="button" onClick={salvarPDF} style={botaoDourado}>
              Salvar como PDF
            </button>
          </div>
          ...
          >
            <div
              style={{
                ...
                height: 32,
                borderRadius: "50%",
                background: index === 0 ? "#173d5c" : "#a6782a",
                color: "white",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
